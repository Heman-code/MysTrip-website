...
// Mock user — replace with real next-auth session
const MOCK_USER = {
  name: "Aarav Sharma",
  email: "aarav@students.muj.ac.in",
...
const tabs = ["Overview", "My Bookings", "Leave a Review"];
    ...
    <div className="min-h-screen" style={{ background: "#F9F7F4" }}>
      ...
      <div style={{ background: "#0B1210" }} className="pt-24 pb-16 relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-start sm:items-center gap-6">
          {/* Avatar */}
          <div
            className="w-18 h-18 rounded-2xl flex items-center justify-center text-2xl font-bold text-white flex-shrink-0"
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-3 mt-2 text-sm text-white/40">
              ...
              <span className="flex items-center gap-1">
                <Clock size={13} />
                Tribe member since {MOCK_USER.joinedDate}
              </span>
            </div>
          </div>
        </div>
        ...
        {activeTab === 0 && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                { num: "0", label: "Trips Taken", icon: "🗺️" },
                { num: "0", label: "States Visited", icon: "📍" },
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { label: "College", value: MOCK_USER.college },
                  { label: "Tribe Role", value: MOCK_USER.role },
                ].map((f) => (
              ...
              <button className="mt-5 text-sm font-semibold px-5 py-2.5 rounded-full border border-gray-200 text-gray-600 hover:border-gray-300 hover:bg-gray-50 transition-all">
                Edit Profile
              </button>
            </div>
          </div>
          ...
          <div>
            ...
            >
              <div className="absolute inset-0 opacity-5">
                <Image src="/trips/gallery-kedarkantha-peaks.jpg" alt="" fill className="object-cover" />
              </div>
              <div className="relative">
                <div
                ...
                <p className="text-white/40 text-sm mb-6 max-w-md mx-auto" style={{ fontFamily: "Mozilla Text, system-ui, sans-serif" }}>
                  We&apos;re putting the finishing touches on payments. In the meantime, reach out on WhatsApp to reserve your spot. No FOMO.
                </p>
                <a
                  href="https://wa.me/918107613759?text=Hey! I want to book a trip with MysTrip."
                  target="_blank"
            ...
            <div className="text-center text-gray-400 text-sm py-8">
              You haven&apos;t taken any trips yet. <Link href="/trips" className="text-gray-600 underline hover:text-gray-800">Browse upcoming events →</Link>
            </div>
          </div>
        )}
          ...
          <div className="max-w-xl">
            {reviewSent ? (
              <div className="bg-white rounded-2xl p-10 text-center border border-gray-100">
                ...
                <p className="text-gray-400 text-sm" style={{ fontFamily: "Mozilla Text, system-ui, sans-serif" }}>
              ...
              <div className="bg-white rounded-2xl border border-gray-100 p-8">
                ...
                <p className="text-sm text-gray-400 mb-6" style={{ fontFamily: "Mozilla Text, system-ui, sans-serif" }}>
                  What went down? Honest reviews help future tribe members pick the right adventure.
                </p>
                ...
                <form onSubmit={submitReview} className="space-y-5">
                  <div>
                    ...
                    >
                      ...
                      <option>Jaisalmer Desert Weekend — Feb 2026</option>
                      <option>Udaipur Exploration — Mar 2026</option>
                      <option>Ban ki Ghati Trek — Apr 2026</option>
                    </select>
                  </div>
                    ...
                    <div className="flex gap-2">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <button
                          ...
                          style={{ filter: star <= review.rating ? "none" : "grayscale(1) opacity(0.3)" }}
                        >
